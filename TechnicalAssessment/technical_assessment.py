...
def combination_exists(objects: list[int], target: int) -> bool:
    """
    Check if there is a combination of the given objects that sum up to the target value.
    ...
    Returns:
    bool: True if there is a combination of the given objects that sum up to the target value, False otherwise
    """
    # Create a new model
